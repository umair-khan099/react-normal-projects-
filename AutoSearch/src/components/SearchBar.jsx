...
const SearchBar = ({ recipes, setinput, setShow, input, show }) => {
  return (
    <div className=" bg-gradient-to-br from-purple-100 to-blue-100 flex flex-col items-center p-2">
            ...
            <div key={recipes.id}>
              <div className="p-3 bg-gray-50 rounded-lg hover:bg-purple-50 cursor-pointer transition">
                <p
                  ...
                  onMouseDown={() => setinput(recipes.name)}
                >
                  {recipes.name}
                </p>
              </div>
